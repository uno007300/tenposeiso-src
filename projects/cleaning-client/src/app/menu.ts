...
export const events: Event[] = [
  {id: 'event1',isCampaign: false, title: '小型店油汚れ清掃プラン', path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/setprice1.jpg', price:'60000', sale:'70000', eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''}], desc:'小型店を応援するための<strong>お得なプラン</strong>です。<strong>厨房の頑固な油汚れ</strong>をキレイに落とします。'},
