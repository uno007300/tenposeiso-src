...
export const whyUsItems: WhyUs[] = [
  ...
  // {id: '2',title: '清掃業者によっては、', link: '',desc: 'エアコンやグリストラップの分解清掃ができない業者や厨房清掃の施工ができない業者もいます。そのため、お店の全体清掃を希望する場合には、数社と連絡を取り、値段の交渉や日程の調整が必要となります。また、清掃料金も高くなってしまいます。店舗清掃.comは客室、厨房、油周り、エアコン、グリストラップ、排水溝、換気扇などの一括見積が可能です。特に、休業明けや新規オープンの店舗にお勧めです。'},
  {id: '04',title: '豪率的な費用算出', link: '',desc: '作業難易度×予想時間×人数で見積りをだします。他社に比べて合理的な費用算出で格安の価格が提示できます。'},
...
export const events: Event[] = [
  {id: 'event1',title: '小型店油汚れ清掃プラン',path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:60000, eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''}], desc:'「店舗清掃.com」だけの特別な「小型店油汚れ清掃プラン」です。'},
  {id: 'event2',title: '小型店厨房丸洗いプラン',path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:80000, eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台', img:''},{ id:'1', item:'作業台', img:''},{ id:'1', item:'厨房床', img:''}], desc:'「店舗清掃.com」だけの特別な「小型店厨房丸洗いプラン」です。'},
  {id: 'event3',title: '小型店トータルリセットプラン',path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:200000, eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台', img:''},{ id:'1', item:'作業台', img:''},{ id:'1', item:'厨房床', img:''},{ id:'1', item:'グリーストラップ', img:''},{ id:'1', item:'業務用エアコン2台', img:''},{ id:'1', item:'客室床清掃・ワックス掛け', img:''},{ id:'1', item:'客室トイレ2室', img:''},{ id:'1', item:'店頭ガラス清掃', img:''}], desc:'「店舗清掃.com」だけの特別な「小型店トータルリセットプラン」です。'},
  {id: 'event4',title: '中型店トータルリセットプラン',path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:450000, eventDetails: [{ id:'1', item:'ダクト・フード×2', img:''},{ id:'1', item:'換気扇×2', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台×2', img:''},{ id:'1', item:'作業台×3', img:''},{ id:'1', item:'厨房床', img:''},{ id:'1', item:'グリーストラップ', img:''},{ id:'1', item:'業務用エアコン6台', img:''},{ id:'1', item:'客室床清掃・ワックス掛け', img:''},{ id:'1', item:'客室トイレ2室', img:''},{ id:'1', item:'店頭ガラス清掃', img:''}], desc:'「店舗清掃.com」だけの特別な「中型店トータルリセットプラン」です。'},
...
export const steps: Step[] = [
  {id: 'Step1',title: 'まずはお問い合わせ',path: '#',img: 'bi bi-house', desc:'まずは、電話、メール、LINEでご連絡ください。当社のスタッフが敏速に対応します。'},
  {id: 'Step2',title: '無料見積り',path: '#',img: 'bi bi-house', desc:'電話、メール、LINEでのお問い合わせにお見積もりをいたします。お見積もりは無料で、追加料金は発生しません。店舗の場合は訪問での見積りが必要な場合があります。'},
