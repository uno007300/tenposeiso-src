...
export const services: Serivce[] = [
  {id: 'tab-1',title: '厨房清掃',path: '#tab-1',desc: 'house',img: 'bi bi-house', isActive: true,beforeImg:'https://fitsys2.blob.core.windows.net/seisopro/images/service/before1.jpg', afterImg:'https://fitsys2.blob.core.windows.net/seisopro/images/service/after1.jpg', serviceDetails: [{id:'1', title:'厨房メンテナンスNo1', desc:'お店の営業終了後の日常清掃の実施は、ゴキブリの繁殖はネズミの侵入を防ぐための一番大事な項目です。清掃の項目によって周期や範囲を分けて実施するのが効率的であります。しかし、お店では簡単にできないところがあります。店舗清掃の一番の悩みは中々落とせない<strong>厨房の頑固な油汚れ</strong>です。店舗清掃.comは当社だけのノーハウで業務用洗剤と専用機材を使い、<strong>厨房の油汚れ</strong>をキレイに落とします。油周り、コンロ周りのお得な<strong>厨房清掃</strong>コースあります。'},{id:'2', title:'１００％自社施工', desc:'清掃業者によっては、エアコンやグリストラップの分解清掃ができない業者や厨房清掃の施工ができない業者もいます。そのため、お店の全体清掃を希望する場合には、数社と連絡を取り、値段の交渉や日程の調整が必要となります。また、清掃料金も高くなってしまいます。店舗清掃.comは<strong>客室、厨房、油周り、エアコン、グリストラップ、排水溝、換気扇</strong>などの一括見積が可能です。特に、休業明けや新規オープンの店舗にお勧めです。'}]},
  {id: 'tab-2',title: '店舗清掃',path: '#tab-2',desc: 'house',img: 'bi bi-house', isActive: false,beforeImg:'https://fitsys2.blob.core.windows.net/seisopro/images/service/before2.jpg', afterImg:'https://fitsys2.blob.core.windows.net/seisopro/images/service/aftet2.jpg', serviceDetails: [{id:'1', title:'店舗メンテナンスNo1', desc:'エアコンと同じく冷蔵／冷凍庫などの機器は冷却フィンがあり、定期的な清掃が必要です。一般的に、冷却フィンの清掃を3年間放置しますと電気代が1.5倍から2倍にアップし、能力は2割から3割ダウンします。<strong>店舗清掃</strong>.comはエアコンと冷却フィンのメンテナンスが可能で、コンデンサー及び冷却フィン清掃も一緒にできますので、割安な価格で費用の節減ができます。'},{id:'2', title:'定期清掃', desc:'店舗をキレイに維持管理するためには専門業者による定期清掃をお勧めします。しかし、名義変更や改装、引き渡しの際に一回だけの清掃を希望する場合もあると思います。店舗清掃.comは一回だけのスポット清掃も承りますので、是非ご相談ください。'}]},
...
export const events: Event[] = [
  {id: 'event1',isCampaign: false, title: '小型店油汚れ清掃プラン', isNeedContact: false, path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/setprice1.jpg', price:'60000', sale:'70000', eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''}], desc:'小型店を応援するための<strong>お得なプラン</strong>です。<strong>厨房の頑固な油汚れ</strong>をキレイに落とします。'},
  {id: 'event2',isCampaign: true, title: '小型店厨房丸洗いプラン', isNeedContact: false, path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/setprice2.jpg', price:'60000', sale:'70000', eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台', img:''},{ id:'1', item:'作業台', img:''},{ id:'1', item:'厨房床', img:''}], desc:'小型店の全体清掃時にお得なプランです。（ドライキッチンは不可）小型店<strong>油周り清掃プラン</strong>に加えて4ドア冷蔵庫や流し台などステンレス製の什器についている汚れまでもきれいに落とせます。作業後には<strong>厨房</strong>内のゴミのかき出しや床のアルカリ洗浄を行います。厨房の全体清掃をお考えの方にお勧めです。'},
  {id: 'event3',isCampaign: false, title: '小型店トータルリセットプラン', isNeedContact: true, path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/setprice3.jpg', price:'200000', sale:'210000', eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台', img:''},{ id:'1', item:'作業台', img:''},{ id:'1', item:'厨房床', img:''},{ id:'1', item:'グリーストラップ', img:''},{ id:'1', item:'業務用エアコン2台', img:''},{ id:'1', item:'客室床清掃・ワックス掛け', img:''},{ id:'1', item:'客室トイレ2室', img:''},{ id:'1', item:'店頭ガラス清掃', img:''}], desc:'厨房丸洗いプランに<string>　グリーストラップ　業務用エアコン　客室の床清掃・ワックス掛け　客室トイレ　店頭のガラス清掃</strong>まで　お店全体の大掃除を行います。名義変更店や新規オープン店など全体にわたって清掃やメンテナンスが必要な場合お得なプランです。特に、コロナ休業後の営業再開を目指している方にお勧めです'},
  {id: 'event4',isCampaign: false, title: '中型店トータルリセットプラン', isNeedContact: true, path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/setprice4.jpg', price:'450000', sale:'460000', eventDetails: [{ id:'1', item:'ダクト・フード×2', img:''},{ id:'1', item:'換気扇×2', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台×2', img:''},{ id:'1', item:'作業台×3', img:''},{ id:'1', item:'厨房床', img:''},{ id:'1', item:'グリーストラップ', img:''},{ id:'1', item:'業務用エアコン6台', img:''},{ id:'1', item:'客室床清掃・ワックス掛け', img:''},{ id:'1', item:'客室トイレ2室', img:''},{ id:'1', item:'店頭ガラス清掃', img:''}], desc:'清掃項目は小型店トータルリセットプランと同じですが、店の規模が大きくなると什器や機材の数が多くなり、通常の見積りですとすぐに数十万の金額になってしまいます。中型店トータルリセットプランは、通常の見積り金額より３割～４割も安くなるお得なプランです。客席数80席程度の中型店で全体清掃をお考えの方は是非ご検討ください。'},
]
