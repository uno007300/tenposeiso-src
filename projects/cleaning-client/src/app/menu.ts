...
export const events: Event[] = [
  {id: 'event1',isCampaign: true, title: '小型店油汚れ清掃プラン', path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:60000, sale:70000, eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''}], desc:'小型店を応援するためのお得なプランです。厨房の頑固な油汚れをキレイに落とします。'},
  {id: 'event2',isCampaign: false, title: '小型店厨房丸洗いプラン', path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:80000, sale:90000, eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台', img:''},{ id:'1', item:'作業台', img:''},{ id:'1', item:'厨房床', img:''}], desc:'小型店の全体清掃時にお得なプランです。（ドライキッチンは不可）小型店油周り清掃プランに加えて4ドア冷蔵庫や流し台などステンレス製の什器についている汚れまでもきれいに落とせます。作業後には厨房内のゴミのかき出しや床のアルカリ洗浄を行います。厨房の全体清掃をお考えの方にお勧めです。'},
  {id: 'event3',isCampaign: false, title: '小型店トータルリセットプラン', path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:200000, sale:210000, eventDetails: [{ id:'1', item:'ダクト・フード', img:''},{ id:'1', item:'換気扇', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台', img:''},{ id:'1', item:'作業台', img:''},{ id:'1', item:'厨房床', img:''},{ id:'1', item:'グリーストラップ', img:''},{ id:'1', item:'業務用エアコン2台', img:''},{ id:'1', item:'客室床清掃・ワックス掛け', img:''},{ id:'1', item:'客室トイレ2室', img:''},{ id:'1', item:'店頭ガラス清掃', img:''}], desc:'厨房丸洗いプランに　グリーストラップ　業務用エアコン　客室の床清掃・ワックス掛け　客室トイレ　店頭のガラス清掃まで　お店全体の大掃除を行います。名義変更店や新規オープン店など全体にわたって清掃やメンテナンスが必要な場合お得なプランです。特に、コロナ休業後の営業再開を目指している方にお勧めです'},
  {id: 'event4',isCampaign: false, title: '中型店トータルリセットプラン', path: '#',img: 'https://fitsys2.blob.core.windows.net/seisopro/images/main/main-img2.jpg', price:450000, sale:460000, eventDetails: [{ id:'1', item:'ダクト・フード×2', img:''},{ id:'1', item:'換気扇×2', img:''},{ id:'1', item:'フライヤー', img:''},{ id:'1', item:'コンロ', img:''},{ id:'1', item:'4ドア冷蔵庫', img:''},{ id:'1', item:'コールドテーブル', img:''},{ id:'1', item:'流し台×2', img:''},{ id:'1', item:'作業台×3', img:''},{ id:'1', item:'厨房床', img:''},{ id:'1', item:'グリーストラップ', img:''},{ id:'1', item:'業務用エアコン6台', img:''},{ id:'1', item:'客室床清掃・ワックス掛け', img:''},{ id:'1', item:'客室トイレ2室', img:''},{ id:'1', item:'店頭ガラス清掃', img:''}], desc:'清掃項目は小型店トータルリセットプランと同じですが、店の規模が大きくなると什器や機材の数が多くなり、通常の見積りですとすぐに数十万の金額になってしまいます。中型店トータルリセットプランは、通常の見積り金額より３割～４割も安くなるお得なプランです。客席数80席程度の中型店で全体清掃をお考えの方は是非ご検討ください。'},
]
